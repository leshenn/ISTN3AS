...
namespace Istn3ASproject.LoginDataSetTableAdapters {
...
SELECT StaffID, UserName, Password, FirstName, LastName, ContactNo, Role FROM Staff WHERE (StaffID = @StaffID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        StaffID, UserName, Password, FirstName, LastName, ContactNo, Role\r\n" +
                "FROM            Staff\r\nWHERE        (UserName = @user) AND (Password = @password" +
                ")";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@user", global::System.Data.SqlDbType.VarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "UserName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(LoginDataSet.StaffDataTable dataTable) {
        ...
        public virtual LoginDataSet.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet.StaffDataTable dataTable = new LoginDataSet.StaffDataTable();
        ...
        public virtual int CheckLogin(LoginDataSet.StaffDataTable dataTable, string user, string password) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet.StaffDataTable dataTable) {
